            ...
            <Menu as="div" className="relative">
              <Menu.Button
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">admin@sgh.edu.vn</p>
                </div>
              </Menu.Button>

              <Menu.Items
                  className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 focus:outline-none z-50">
                <div className="py-1">
                  <Menu.Item>
                    {({active}) => (
                        <button
