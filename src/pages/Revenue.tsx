  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        ...
        {/* Period Info */}
        {revenueLoading ? (
          <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg animate-pulse">
      ...
      {revenueLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {Array.from({ length: 4 }).map((_, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-gray-300 to-gray-400 rounded-xl p-6 animate-pulse"
            >
