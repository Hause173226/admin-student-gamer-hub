...
const MemberShipManagement = lazy(() => import('./pages/MembershipManagement.tsx'));
...
function App() {
    return (
        <Router >
            <Suspense fallback={<div className="p-8 text-center text-gray-500">Loading SGH Admin...</div>}>
                <Routes>
